...
return array (
  ...
  'aozoraminchomedium' => array(
    'normal' => $rootDir . '/lib/fonts/aozoraminchomedium',
    'bold' => $rootDir . '/lib/fonts/aozoraminchomedium',
    'italic' => $rootDir . '/lib/fonts/aozoraminchomedium',
    'bold_italic' => $rootDir . '/lib/fonts/aozoraminchomedium',
  ),
  'takaopgothic' => array(
    'normal' => $rootDir . '/lib/fonts/takaopgothic',
    'bold' => $rootDir . '/lib/fonts/takaopgothic',
    'italic' => $rootDir . '/lib/fonts/takaopgothic',
    'bold_italic' => $rootDir . '/lib/fonts/takaopgothic',
  ),
  'ipag' => array(
    'normal' => $rootDir . '/lib/fonts/ipag',
    'bold' => $rootDir . '/lib/fonts/ipag',
    'italic' => $rootDir . '/lib/fonts/ipag',
    'bold_italic' => $rootDir . '/lib/fonts/ipag',
  ),
  'ipag.ttf' => array(
    'normal' => $fontDir . '/ipag',
    'bold' => $fontDir . '/ipag',
